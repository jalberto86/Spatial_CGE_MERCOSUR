* This file is called passing 2 args "initvar" which becomes theMacro, and "tsim" which becomes theYear
...
%theMacro%1(vaNLND,a,0) ;
%theMacro%1(vaLND,a,0) ;
%theMacro%1(px,a,1) ;
...
%theMacro%1(pva,a,1) ;
*  17JUL2022--Added for GTAP-LU
%theMacro%1(pvaNLND,a,1) ;
%theMacro%1(pvaLND,a,1) ;
%theMacro%1(pvaLNDNDX,a,1) ;
...
%theMacro%4g(xmgm,m,r,i,rp,0) ;
%theMacro%2(pwmg,i,rp,1) ;
%theMacro%1g(xtmg,m,0) ;
...
%theMacro%1(vtfp,a,1) ;
%theMacro%1(nlndtfp,a,1) ;
%theMacro%1(lndtfp,a,1) ;
