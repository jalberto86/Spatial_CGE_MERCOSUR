...
*  Production variables
   ...
   loop((r,a,t)$xpFlag(r,a),
      ...
      if(valnd0(r,a),
         put "vaLND",  r.tl, a.tl, "", years(t):4:0, ((vaLND0(r,a)*vaLND.l(r,a,t))/inScale) / ;
         put "pvaLND", r.tl, a.tl, "", years(t):4:0, ((pvaLND0(r,a)*pvaLND.l(r,a,t))) / ;
      ) ;
   ) ;
