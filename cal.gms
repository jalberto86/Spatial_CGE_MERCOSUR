...
loop(t$t0(t),
   ...
   pvaNLND.l(r,a,t) = ifdebug*uniform(0.5,1.5) + (1 - ifDebug)*1 ;
   pvaLND.l(r,a,t)  = ifdebug*uniform(0.5,1.5) + (1 - ifDebug)*1 ;
...
*  GTAP-LU
      pvaNLND.l(r,a,t)    = pvaNLND.l(r,a,t0) ;
      pvaLND.l(r,a,t)     = pvaLND.l(r,a,t0) ;
...
*  GTAP-LU
vaNLND.l(r,a,t) = sum(fp$(not lnd(fp)), pfa.l(r,fp,a,t)*xf.l(r,fp,a,t))/pvaNLND.l(r,a,t) ;
*  Make land add up in the reference year
vaLND.l(r,a,t)  = sum(fp$lnd(fp), xf.l(r,fp,a,t)) ;
pvaLND.l(r,a,t) = (sum(fp$lnd(fp), pfa.l(r,fp,a,t)*xf.l(r,fp,a,t))/vaLND.l(r,a,t))$vaLnd.l(r,a,t)
                + 1$(not vaLND.l(r,a,t)) ;
va.l(r,a,t)     = (pvaNLND.l(r,a,t)*vaNLND.l(r,a,t)
                +  pvaLND.l(r,a,t)*vaLND.l(r,a,t))/pva.l(r,a,t) ;
pvaLNDNDX.l(r,a,t)  = pvaLND.l(r,a,t) ;

loop(t0,
   vaFlag(r,a)$va.l(r,a,t0)         = 1 ;
   vaNLNDFlag(r,a)$vaNLND.l(r,a,t0) = 1 ;
   vaLNDFlag(r,a)$vaLND.l(r,a,t0)   = 1 ;
...
* pop(r,t) is updated by the SSP-specific population path inside the recursive simulation.
pop.l(r,t)  = pop0(r) ;
pop.fx(r,t0) = pop0(r) ;
...
*prdtx.l(r,a,i,t)$prdtx.l(r,a,i,t) = x.l(r,a,i,t)/1-prdtx.l(r,a,i,t) ;
*prdtx.l(r,a,i,t)$prdtx.l(r,a,i,t) = x.l(r,a,i,t)/prdtx.l(r,a,i,t) ;
...
*prdtx_1.l(r,a,i,t) = inScale*ptax(i,a,r);
*prdtx_1.l(r,a,i,t)$prdtx_1.l(r,a,i,t) =  x.l(r,a,i,t)/prdtx_1.l(r,a,i,t) - 1 ;
...
pmCIF.l(s,i,d,t)
   = (pefob.l(s,i,d,t) + pwmg.l(s,i,d,t)*tmarg.l(s,i,d,t)) ;
...
*  17JUL2022--Added for GTAP-LU

*  sigmakl is subsitution across capita-labor (and NRS), by default equal to esubkl
*  use value added weights
   tvom(a0,r) = sum(fp$(not lnd(fp)), evfp(fp,a0,r)) ;
   sigmakl(r,a)$(sigmakl(r,a) eq na and vaNLND.l(r,a,t0))
      = sum(a0$mapa0(a0,a), tvom(a0,r)*esubkl(a0,r))/sum(a0$mapa0(a0,a), tvom(a0,r)) ;

*  sigmalnd is subsitution across land-types, by default equal to esublnd
*  use value added weights
   tvom(a0,r) = sum(fp$lnd(fp), evfp(fp,a0,r)) ;
   sigmalnd(r,a)$(sigmalnd(r,a) eq na and vaLND.l(r,a,t0))
      = sum(a0$mapa0(a0,a), tvom(a0,r)*esublnd(a0,r))/sum(a0$mapa0(a0,a), tvom(a0,r)) ;

   sigmalnd(r,a)$(sigmalnd(r,a) eq na) = 0 ;
...
loop(tsim$t0(tsim),
   ts(tsim) = yes ;
   options limrow=3, limcol=3, solprint=on ;
...
if(0,
   andd(r,a,t)$ndFlag(r,a) = (nd.l(r,a,t)/xp.l(r,a,t))*(pnd.l(r,a,t)/px.l(r,a,t))**sigmap(r,a) ;
   ava(r,a,t)$vaFlag(r,a) = (va.l(r,a,t)/xp.l(r,a,t))*(pva.l(r,a,t)/px.l(r,a,t))**sigmap(r,a) ;
else
   andd(r,a,t)$ndFlag(r,a) = (pnd.l(r,a,t)*nd.l(r,a,t))/(px.l(r,a,t)*xp.l(r,a,t)) ;
...
if(0,
   aNLND(r,a,t)$vanlndFlag(r,a)
      = (vaNLND.l(r,a,t)/va.l(r,a,t))*(pvaNLND.l(r,a,t)/pva.l(r,a,t))**sigmav(r,a) ;
   aLND(r,a,t)$vanlndFlag(r,a)
      = (vaLND.l(r,a,t)/va.l(r,a,t))*(pvaLND.l(r,a,t)/pva.l(r,a,t))**sigmav(r,a) ;
else
   aNLND(r,a,t)$vanlndFlag(r,a)
      = (pvaNLND.l(r,a,t)*vaNLND.l(r,a,t))/(pva.l(r,a,t)*va.l(r,a,t)) ;
   aLND(r,a,t)$valndFlag(r,a)
      = ((pvaLND.l(r,a,t)*vaLND.l(r,a,t))/(pva.l(r,a,t)*va.l(r,a,t))) ;
) ;
...
*  GTAP-LU
if(0,
   af(r,fp,a,t)$xfFlag(r,fp,a) = ((xf.l(r,fp,a,t)/vaNLND.l(r,a,t))
                               * (pfa.l(r,fp,a,t)/pvaNLND.l(r,a,t))**sigmakl(r,a))
                               $(not lnd(fp))

                               + ((xf.l(r,fp,a,t)/vaLND.l(r,a,t))
                               * (pfa.l(r,fp,a,t)/pvaLND.l(r,a,t))**sigmalnd(r,a))
                               $lnd(fp)
                               ;
else
   af(r,fp,a,t)$xfFlag(r,fp,a) = ((pfa.l(r,fp,a,t)*xf.l(r,fp,a,t))
                               /  (pvaNLND.l(r,a,t)*vaNLND.l(r,a,t)))
                               $(not lnd(fp))

                               + ((pfa.l(r,fp,a,t)*xf.l(r,fp,a,t))
                               /  (pvaLND.l(r,a,t)*vaLND.l(r,a,t)))
                               $(not ifAddLand and lnd(fp))

                               + (xf.l(r,fp,a,t)/vaLND.l(r,a,t))
                               $(ifAddLand and lnd(fp))
                               ;
) ;
...
loop(t$t0(t),
   amgm(m,s,i,d)$xwmg.l(s,i,d,t) = (ptmg.l(m,t)*xmgm.l(m,s,i,d,t))
                                 / (pwmg.l(s,i,d,t)*xwmg.l(s,i,d,t)) ;
) ;
...
loop((r,fm),
   if(0 and omegaf(r,fm) ne inf,
      ...
      gf(r,fm,a,t)$xfFlag(r,fm,a) =
         ((pfy.l(r,fm,a,t)*xf.l(r,fm,a,t))/(pft.l(r,fm,t)*xft.l(r,fm,t)))$(not ifAddLand)
      +  (xf.l(r,fm,a,t)/xft.l(r,fm,t))$ifAddLand
      ;
   ) ;
) ;
