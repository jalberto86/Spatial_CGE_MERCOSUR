...
$if not setGlobal simName $setGlobal simName Rdyn
...
scalar
   ...
   ifShock     "Set to 1 to include shock file"           / %ifShock% /   
...
if(ifCSV,
   if(ifCSVAppend,
      ...
      put "META,MRIO,%MRIO%" / ;
      put "META,ifShock,%ifShock%" / ;
      put "META,Shock,%Shock%" / ;
      put / ;
